...
test.describe.serial('Verify Sales Enquiry API', () => {
    ...
    test('Verify Create Embroiding And Tailoring API', async () => {
    ...
    test('Verify Create Signage Illuminated API', async () => {
    ...
    test('Verify Create ATM Products API', async () => {
    ...
    test('Verify Create Vinyl Graphic API', async () => {
    ...
    test('Verify Create Trading Products API', async () => {
    ...
    test('Verify Create PVC Products API', async () => {
    ...
    test('Verify View Sales Enquiry API', async () => {
    ...
    test('Verify Edit Sales Enquiry API', async () => {
    ...
    test('Verify Delete Sales Enquiry API', async () => {
