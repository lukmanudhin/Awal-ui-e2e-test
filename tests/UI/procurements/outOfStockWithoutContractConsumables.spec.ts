...
test.describe('Material Indent and Material Issue For Out of Stock Consumables With out Contract End-to-End Scenarios', () => {
    ...
    test('Verify an out of stock material with no contract is procured through a vendor quotation and issued after put away', async ({ materialIndentRequestAPI, salesEnquiryAPI, stockViewAPI, putAwayPage, grnEntryPage, procurementPage, prRequestPage, modules, materialIndentRequestPage, vendorRegistrationPage }) => {
