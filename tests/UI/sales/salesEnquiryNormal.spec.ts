...
test.describe.serial('Verify E2E flow of Sales Enquiry (Request Normal)', () => {
    ...
    test('Verify that the estimation request is displayed in the Estimation - Request (Normal) list', async () => {
    ...
    test('Verify estimation status in Request Normal is updated to Pending For Approval after submission', async () => {
    ...
    test('Quotation: Verify send quotation to customer and advance invoice request is submitted successfully', async () => {
