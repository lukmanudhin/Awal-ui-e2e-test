...
test.describe.serial('Verify Sales Order Manager Rejects the Checklist', () => {
    ...
    test('Verify Sales Order Manager rejects the checklist', async ({ page, modules, salesEnquiryPage, salesOrderManagerPage, quotationManagerPage, ppjoPage, invoiceRequestPage, requestNormalPage, costEstimationPage, requestApprovalPage }) => {
        ...
        await test.step('Verify Sales Order Manager rejects the checklist', async () => {
            ...
            await salesOrderManagerPage.rejectSalesOrderCheckListAndValidateAPI(200);
            await expect(salesOrderManagerPage.successMessage('Sales Order Checklist rejected successfully'), "Sales Order Checklist Rejected successfully message does not match").toContainText('Sales Order Checklist rejected successfully');
